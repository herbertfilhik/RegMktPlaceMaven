...
public class CadastraParceiroTest {
	  ...
	  public void inputdedados() throws Exception {
	    ...
	    new Select(driver.findElement(By.id("plataform"))).selectByVisibleText("VTEX");
	    driver.findElement(By.cssSelector("#plataform > option[value=\"9\"]")).click();
	    driver.findElement(By.id("integrator")).click();
	    new Select(driver.findElement(By.id("integrator"))).selectByVisibleText("VTEX");
